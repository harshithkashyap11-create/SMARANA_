...
- [ ] **T100** Games 8 & 9: Who Is This (family) and Word Pairs — L (after T092)
- [ ] **T101** Games 10 & 11: Spot the Change and Festival Match — L (after T092)
- [ ] **T102** Game 12: Sound Match — M (after T092)
- [ ] **T103** Favourites and suggested activities — S (after T100)
- [ ] **T104** Walkthrough mode and Replay Instructions — M (after T082)
- [ ] **T105** Guest practice mode — S (after T032)
- [ ] **T106** Sleep and mood logs (patient + caregiver) and doctor visibility by consent — M (after T070, T046)
- [ ] **T107** 'I feel confused / I need a break' mode — M (after T023b, T104)
- [ ] **T108** Caregiver Timeline tab, routine conflict detection, Care Team tab — M (after T046, T042)
- [ ] **T109** Remaining alert rules and notification preferences — M (after T044, T106)
- [ ] **T110** PDF clinical report and caregiver report (WeasyPrint) with disclaimer + export audit — L (after T051, T055, T044)
- [ ] **T111** Printable emergency card and print styles — S (after T110)
- [ ] **T112** Final accessibility and copy pass, walkthrough of all demo scripts — M (after T104, T107, T110)
